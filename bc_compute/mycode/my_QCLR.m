function [map,map_mu] = my_QCLR(face,vertex,dimension,varargin)
...
[map,update_mu] = lbs_rect(face,vertex,mu,'Corner',corner,'Height',dimension(1),'Width',dimension(2));
...
while (tolerance > .1)  || count ~= 0
    ...
    for p = 1:P.dt_Number
        [~,update_mu] = lbs_rect(face,vertex,smooth_mu,'Corner',corner,'Height',dimension(1),'Width',dimension(2));
