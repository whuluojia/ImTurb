function [map,map_mu,register] = my_registration_lm(face,vertex,previous_map,moving,static,gaussian_size)
...
for k = 1:5
    ...
    updated_map = lbs_rect(face,vertex,smooth_mu,'height',size(static,1)-1,'width',size(static,2)-1);
    mu = bc_metric(face,vertex,updated_map,2);
    ...
    temp_moving = imwarp(temp_moving,D,'cubic');
